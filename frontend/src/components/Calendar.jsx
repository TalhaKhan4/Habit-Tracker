...
function Calendar({
  ...
  return (
    <div className="font-sans flex flex-col justify-between border-[2px] border-gray-400  rounded-2xl overflow-hidden">
          ...
          return (
            <button
              ...
              className={`disabled:cursor-not-allowed cursor-pointer text-lg  ${
                ...
                dateObj.month !== selectedMonth && "text-gray-400 bg-gray-200"
              } ${
                dateObj.date === selectedDate.date &&
